#!/usr/bin/env bash
# scripts/build/build-bundles.sh — bundle creator code to ivm-loadable script.
#
# Usage:
#   ./scripts/build/build-bundles.sh            # build every examples/bundles/* with a src/index.mts
#   ./scripts/build/build-bundles.sh hello-ws-echo  # build just one
#
...
BUNDLES_DIR="$REPO_ROOT/examples/bundles"
