...
| # | Task | Progress |
|---|---|---|
| 1 | **Bootstrap preflight** — Run or dry-run the Fly/Tigris/Upstash bootstrap path as far as credentials allow, preserving the hard-coded teardown allowlist. Verify the three Fly apps, Tigris bucket, Upstash Redis, Infisical sync, shared-secret drift check, and spend-marker behavior are production-shaped. | `to_do` |
