...
fn convert_bare<T, U>(value: T) -> Result<U>
where
	T: serde::Serialize,
	U: serde::de::DeserializeOwned,
{
	let bytes = serde_bare::to_vec(&value)?;
	serde_bare::from_slice(&bytes).map_err(Into::into)
}
...
impl ToClientMk2 {
	...
	fn v7_to_v8(self) -> Result<Self> {
		if let ToClientMk2::V7(x) = self {
			Ok(ToClientMk2::V8(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
	...
	fn v8_to_v7(self) -> Result<Self> {
		if let ToClientMk2::V8(x) = self {
			Ok(ToClientMk2::V7(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
...
impl ToServerMk2 {
	...
	fn v7_to_v8(self) -> Result<Self> {
		if let ToServerMk2::V7(x) = self {
			Ok(ToServerMk2::V8(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
	...
	fn v8_to_v7(self) -> Result<Self> {
		if let ToServerMk2::V8(x) = self {
			Ok(ToServerMk2::V7(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
...
impl ToRunnerMk2 {
	...
	fn v7_to_v8(self) -> Result<Self> {
		if let ToRunnerMk2::V7(x) = self {
			Ok(ToRunnerMk2::V8(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
	...
	fn v8_to_v7(self) -> Result<Self> {
		if let ToRunnerMk2::V8(x) = self {
			Ok(ToRunnerMk2::V7(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
...
impl OwnedVersionedData for ToGateway {
	...
	fn serialize_converters() -> Vec<impl Fn(Self) -> Result<Self>> {
		vec![Self::v8_to_v7, Ok, Ok, Ok, Self::v7_to_v3, Ok, Ok]
	}
}
...
impl ToGateway {
	...
	fn v7_to_v8(self) -> Result<Self> {
		if let ToGateway::V7(x) = self {
			Ok(ToGateway::V8(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
	...
	fn v8_to_v7(self) -> Result<Self> {
		if let ToGateway::V8(x) = self {
			Ok(ToGateway::V7(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
...
impl ToServerlessServer {
	...
	fn v7_to_v8(self) -> Result<Self> {
		if let ToServerlessServer::V7(x) = self {
			Ok(ToServerlessServer::V8(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
	...
	fn v8_to_v7(self) -> Result<Self> {
		if let ToServerlessServer::V8(x) = self {
			Ok(ToServerlessServer::V7(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
...
impl ActorCommandKeyData {
	...
	fn v7_to_v8(self) -> Result<Self> {
		if let ActorCommandKeyData::V7(x) = self {
			Ok(ActorCommandKeyData::V8(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
	...
	fn v8_to_v7(self) -> Result<Self> {
		if let ActorCommandKeyData::V8(x) = self {
			Ok(ActorCommandKeyData::V7(convert_bare(x)?))
		} else {
			bail!("unexpected version");
		}
	}
