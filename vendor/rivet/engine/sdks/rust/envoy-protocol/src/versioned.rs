...
{
	serde_bare::from_slice(&serde_bare::to_vec(&message)?).map_err(Into::into)
}

fn convert_same_bytes_ref<T, U>(message: &T) -> Result<U>
where
...
impl ProtocolCompatibilityFeature {
	fn description(self, direction: ProtocolCompatibilityDirection) -> &'static str {
		match self {
			...
			ProtocolCompatibilityFeature::TunnelPressure => match direction {
				ProtocolCompatibilityDirection::ToEnvoy => "tunnel pressure updates",
				ProtocolCompatibilityDirection::ToRivet => "tunnel pressure updates",
			},
		}
	}
}
...
impl fmt::Display for ProtocolCompatibilityError {
	fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
		let verb = match self.feature {
			...
			| ProtocolCompatibilityFeature::TunnelPressure => "require",
		};
...
impl OwnedVersionedData for ToEnvoy {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		Ok(Self::V6(match version {
			1 => convert_to_envoy_v5_to_v6(convert_to_envoy_v4_to_v5(convert_to_envoy_v3_to_v4(
				convert_to_envoy_v2_to_v3(convert_to_envoy_v1_to_v2(serde_bare::from_slice(
					payload,
				)?)?)?,
			)?)?)?,
			2 => convert_to_envoy_v5_to_v6(convert_to_envoy_v4_to_v5(convert_to_envoy_v3_to_v4(
				convert_to_envoy_v2_to_v3(serde_bare::from_slice(payload)?)?,
			)?)?)?,
			3 => convert_to_envoy_v5_to_v6(convert_to_envoy_v4_to_v5(convert_to_envoy_v3_to_v4(
				serde_bare::from_slice(payload)?,
			)?)?)?,
			4 => convert_to_envoy_v5_to_v6(convert_to_envoy_v4_to_v5(serde_bare::from_slice(
				payload,
			)?)?)?,
	...
	fn serialize_version(self, version: u16) -> Result<Vec<u8>> {
		...
		match version {
			...
			4 => serde_bare::to_vec(&convert_to_envoy_v5_to_v4(convert_to_envoy_v6_to_v5(
				data, 4,
			)?)?)
			.map_err(Into::into),
...
impl OwnedVersionedData for ToRivet {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		Ok(Self::V6(match version {
			1 | 2 => convert_same_bytes(convert_to_rivet_v4_to_v5(convert_to_rivet_v3_to_v4(
				convert_to_rivet_v2_to_v3(serde_bare::from_slice(payload)?)?,
			)?)?)?,
			3 => convert_same_bytes(convert_to_rivet_v4_to_v5(convert_to_rivet_v3_to_v4(
				serde_bare::from_slice(payload)?,
			)?)?)?,
			4 => convert_same_bytes(convert_to_rivet_v4_to_v5(serde_bare::from_slice(payload)?)?)?,
			5 => convert_same_bytes(serde_bare::from_slice::<v5::ToRivet>(payload)?)?,
			6 => serde_bare::from_slice(payload)?,
			_ => bail!("invalid version: {version}"),
		}))
	}
	...
	fn serialize_version(self, version: u16) -> Result<Vec<u8>> {
		let Self::V6(data) = self;
		let data_v5 = || convert_same_bytes_ref::<_, v5::ToRivet>(&data);
		match version {
			1 | 2 => {
				let data = convert_to_rivet_v5_to_v4(data_v5()?)?;
			...
			4 => serde_bare::to_vec(&convert_to_rivet_v5_to_v4(data_v5()?)?).map_err(Into::into),
			5 => serde_bare::to_vec(&data_v5()?).map_err(Into::into),
			6 => serde_bare::to_vec(&data).map_err(Into::into),
			_ => bail!("invalid version: {version}"),
		}
	}
...
impl OwnedVersionedData for ToEnvoyConn {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		Ok(Self::V6(match version {
			...
			2 => convert_same_bytes(convert_to_envoy_conn_v2_to_v3(serde_bare::from_slice(
				payload,
			)?)?)?,
	...
	fn serialize_version(self, version: u16) -> Result<Vec<u8>> {
		let Self::V6(data) = self;
		let data_v5 = || convert_to_envoy_conn_v6_to_v5(data.clone(), version);
		let data_v4 = || convert_same_bytes_ref::<_, v4::ToEnvoyConn>(&data_v5()?);
		match version {
			1 => {
				let data = data_v4()?;
			...
			3 => {
				let data = data_v4()?;
				serde_bare::to_vec(&convert_same_bytes_ref::<_, v3::ToEnvoyConn>(&data)?)
					.map_err(Into::into)
			}
...
impl OwnedVersionedData for ToGateway {
	...
	fn serialize_version(self, version: u16) -> Result<Vec<u8>> {
		let Self::V6(data) = self;
		let data_v5 = || convert_same_bytes_ref::<_, v5::ToGateway>(&data);
		let data_v4 = || convert_same_bytes_ref::<_, v4::ToGateway>(&data_v5()?);
		match version {
			1 => {
				let data = data_v4()?;
				let data = convert_same_bytes_ref::<_, v3::ToGateway>(&data)?;
				serde_bare::to_vec(&convert_to_gateway_v3_to_v1(data)).map_err(Into::into)
			}
			2 => {
				let data = data_v4()?;
				let data = convert_same_bytes_ref::<_, v3::ToGateway>(&data)?;
			...
			3 => {
				let data = data_v4()?;
				serde_bare::to_vec(&convert_same_bytes_ref::<_, v3::ToGateway>(&data)?)
					.map_err(Into::into)
			}
			4 => serde_bare::to_vec(&data_v4()?).map_err(Into::into),
			5 => serde_bare::to_vec(&data_v5()?).map_err(Into::into),
...
impl OwnedVersionedData for ToOutbound {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		Ok(Self::V6(match version {
			...
			2 => convert_same_bytes(convert_to_outbound_v2_to_v3(serde_bare::from_slice(
				payload,
			)?))?,
	...
	fn serialize_version(self, version: u16) -> Result<Vec<u8>> {
		let Self::V6(data) = self;
		let data_v5 = || convert_same_bytes_ref::<_, v5::ToOutbound>(&data);
		let data_v4 = || convert_same_bytes_ref::<_, v4::ToOutbound>(&data_v5()?);
		match version {
			1 => {
				let data = data_v4()?;
				let data = convert_same_bytes_ref::<_, v3::ToOutbound>(&data)?;
				serde_bare::to_vec(&convert_to_outbound_v3_to_v1(data)).map_err(Into::into)
			}
			2 => {
				let data = data_v4()?;
				let data = convert_same_bytes_ref::<_, v3::ToOutbound>(&data)?;
			...
			3 => {
				let data = data_v4()?;
				serde_bare::to_vec(&convert_same_bytes_ref::<_, v3::ToOutbound>(&data)?)
					.map_err(Into::into)
			}
			4 => serde_bare::to_vec(&data_v4()?).map_err(Into::into),
			5 => serde_bare::to_vec(&data_v5()?).map_err(Into::into),
...
impl OwnedVersionedData for ActorCommandKeyData {
	...
	fn deserialize_version(payload: &[u8], version: u16) -> Result<Self> {
		Ok(Self::V6(match version {
			...
			2 => convert_same_bytes(convert_actor_command_key_data_v2_to_v3(
				serde_bare::from_slice(payload)?,
			))?,
	...
	fn serialize_version(self, version: u16) -> Result<Vec<u8>> {
		let Self::V6(data) = self;
		let data_v5 = || convert_same_bytes_ref::<_, v5::ActorCommandKeyData>(&data);
		let data_v4 = || convert_same_bytes_ref::<_, v4::ActorCommandKeyData>(&data_v5()?);
		match version {
			1 => {
				let data = data_v4()?;
				let data = convert_same_bytes_ref::<_, v3::ActorCommandKeyData>(&data)?;
...
fn convert_to_envoy_v6_to_v5(message: v6::ToEnvoy, target_version: u16) -> Result<v5::ToEnvoy> {
	match message {
		v6::ToEnvoy::ToEnvoyTunnelPressure(_) => Err(incompatible(
			ProtocolCompatibilityFeature::TunnelPressure,
			ProtocolCompatibilityDirection::ToEnvoy,
			6,
			target_version,
		)),
		other => convert_same_bytes(other),
	}
}

fn convert_to_envoy_conn_v6_to_v5(
	message: v6::ToEnvoyConn,
	target_version: u16,
) -> Result<v5::ToEnvoyConn> {
	match message {
		v6::ToEnvoyConn::ToEnvoyTunnelPressure(_) => Err(incompatible(
			ProtocolCompatibilityFeature::TunnelPressure,
			ProtocolCompatibilityDirection::ToEnvoy,
			6,
			target_version,
...
fn convert_to_envoy_v4_to_v5(message: v4::ToEnvoy) -> Result<v5::ToEnvoy> {
	Ok(match message {
		v4::ToEnvoy::ToEnvoyInit(data) => v5::ToEnvoy::ToEnvoyInit(convert_same_bytes(data)?),
		v4::ToEnvoy::ToEnvoyCommands(data) => {
			v5::ToEnvoy::ToEnvoyCommands(convert_same_bytes(data)?)
		}
		v4::ToEnvoy::ToEnvoyAckEvents(data) => {
			v5::ToEnvoy::ToEnvoyAckEvents(convert_same_bytes(data)?)
		}
		v4::ToEnvoy::ToEnvoyKvResponse(data) => {
			v5::ToEnvoy::ToEnvoyKvResponse(convert_same_bytes(data)?)
		}
		v4::ToEnvoy::ToEnvoyTunnelMessage(data) => {
			v5::ToEnvoy::ToEnvoyTunnelMessage(convert_same_bytes(data)?)
		}
		v4::ToEnvoy::ToEnvoyPing(data) => v5::ToEnvoy::ToEnvoyPing(convert_same_bytes(data)?),
		v4::ToEnvoy::ToEnvoySqliteGetPagesResponse(data) => {
			v5::ToEnvoy::ToEnvoySqliteGetPagesResponse(v5::ToEnvoySqliteGetPagesResponse {
				request_id: data.request_id,
				data: convert_sqlite_get_pages_response_v4_to_v5(data.data)?,
			})
		}
		v4::ToEnvoy::ToEnvoySqliteCommitResponse(data) => {
			v5::ToEnvoy::ToEnvoySqliteCommitResponse(v5::ToEnvoySqliteCommitResponse {
				request_id: data.request_id,
				data: convert_sqlite_commit_response_v4_to_v5(data.data)?,
			})
		}
		v4::ToEnvoy::ToEnvoySqliteExecResponse(data) => {
			v5::ToEnvoy::ToEnvoySqliteExecResponse(v5::ToEnvoySqliteExecResponse {
				request_id: data.request_id,
				data: convert_sqlite_exec_response_v4_to_v5(data.data)?,
			})
		}
		v4::ToEnvoy::ToEnvoySqliteExecuteResponse(data) => {
			v5::ToEnvoy::ToEnvoySqliteExecuteResponse(v5::ToEnvoySqliteExecuteResponse {
				request_id: data.request_id,
				data: convert_sqlite_execute_response_v4_to_v5(data.data)?,
			})
		}
	})
}

fn convert_to_envoy_v5_to_v4(message: v5::ToEnvoy) -> Result<v4::ToEnvoy> {
	Ok(match message {
		v5::ToEnvoy::ToEnvoyInit(data) => v4::ToEnvoy::ToEnvoyInit(convert_same_bytes(data)?),
		v5::ToEnvoy::ToEnvoyCommands(data) => {
			v4::ToEnvoy::ToEnvoyCommands(convert_same_bytes(data)?)
		}
		v5::ToEnvoy::ToEnvoyAckEvents(data) => {
			v4::ToEnvoy::ToEnvoyAckEvents(convert_same_bytes(data)?)
		}
		v5::ToEnvoy::ToEnvoyKvResponse(data) => {
			v4::ToEnvoy::ToEnvoyKvResponse(convert_same_bytes(data)?)
		}
		v5::ToEnvoy::ToEnvoyTunnelMessage(data) => {
			v4::ToEnvoy::ToEnvoyTunnelMessage(convert_same_bytes(data)?)
		}
		v5::ToEnvoy::ToEnvoyPing(data) => v4::ToEnvoy::ToEnvoyPing(convert_same_bytes(data)?),
		v5::ToEnvoy::ToEnvoySqliteGetPagesResponse(data) => {
			v4::ToEnvoy::ToEnvoySqliteGetPagesResponse(v4::ToEnvoySqliteGetPagesResponse {
				request_id: data.request_id,
				data: convert_sqlite_get_pages_response_v5_to_v4(data.data)?,
			})
		}
		v5::ToEnvoy::ToEnvoySqliteCommitResponse(data) => {
			v4::ToEnvoy::ToEnvoySqliteCommitResponse(v4::ToEnvoySqliteCommitResponse {
				request_id: data.request_id,
				data: convert_sqlite_commit_response_v5_to_v4(data.data)?,
			})
		}
		v5::ToEnvoy::ToEnvoySqliteExecResponse(data) => {
			v4::ToEnvoy::ToEnvoySqliteExecResponse(v4::ToEnvoySqliteExecResponse {
				request_id: data.request_id,
				data: convert_sqlite_exec_response_v5_to_v4(data.data)?,
			})
		}
		v5::ToEnvoy::ToEnvoySqliteExecuteResponse(data) => {
			v4::ToEnvoy::ToEnvoySqliteExecuteResponse(v4::ToEnvoySqliteExecuteResponse {
				request_id: data.request_id,
				data: convert_sqlite_execute_response_v5_to_v4(data.data)?,
			})
		}
	})
}

fn convert_sqlite_error_response_v4_to_v5(
	error: v4::SqliteErrorResponse,
...
fn convert_sqlite_error_response_v5_to_v4(
	error: v5::SqliteErrorResponse,
) -> v4::SqliteErrorResponse {
	v4::SqliteErrorResponse {
		message: error.message,
	}
}

fn convert_sqlite_get_pages_response_v4_to_v5(
	message: v4::SqliteGetPagesResponse,
) -> Result<v5::SqliteGetPagesResponse> {
	Ok(match message {
		v4::SqliteGetPagesResponse::SqliteGetPagesOk(ok) => {
			v5::SqliteGetPagesResponse::SqliteGetPagesOk(v5::SqliteGetPagesOk {
				pages: convert_same_bytes(ok.pages)?,
				head_txid: None,
			})
		}
...
fn convert_sqlite_commit_response_v4_to_v5(
	message: v4::SqliteCommitResponse,
...
fn convert_sqlite_commit_response_v5_to_v4(
...
fn convert_sqlite_exec_response_v4_to_v5(
	message: v4::SqliteExecResponse,
) -> Result<v5::SqliteExecResponse> {
	Ok(match message {
		v4::SqliteExecResponse::SqliteExecOk(ok) => {
...
fn convert_sqlite_exec_response_v5_to_v4(
...
fn convert_sqlite_execute_response_v4_to_v5(
	message: v4::SqliteExecuteResponse,
) -> Result<v5::SqliteExecuteResponse> {
	Ok(match message {
		v4::SqliteExecuteResponse::SqliteExecuteOk(ok) => {
...
fn convert_sqlite_execute_response_v5_to_v4(
...
fn convert_to_rivet_v4_to_v5(message: v4::ToRivet) -> Result<v5::ToRivet> {
	convert_same_bytes(message)
}

fn convert_to_rivet_v5_to_v4(message: v5::ToRivet) -> Result<v4::ToRivet> {
	convert_same_bytes(message)
}

fn convert_to_envoy_v3_to_v4(message: v3::ToEnvoy) -> Result<v4::ToEnvoy> {
	convert_same_bytes(message)
}

fn convert_to_envoy_v4_to_v3(message: v4::ToEnvoy, target_version: u16) -> Result<v3::ToEnvoy> {
	match &message {
		...
		v4::ToEnvoy::ToEnvoyInit(_)
		| v4::ToEnvoy::ToEnvoyCommands(_)
		| v4::ToEnvoy::ToEnvoyAckEvents(_)
		| v4::ToEnvoy::ToEnvoyKvResponse(_)
		| v4::ToEnvoy::ToEnvoyTunnelMessage(_)
		| v4::ToEnvoy::ToEnvoyPing(_)
		| v4::ToEnvoy::ToEnvoySqliteGetPagesResponse(_)
		| v4::ToEnvoy::ToEnvoySqliteCommitResponse(_) => {}
	}

	convert_same_bytes(message)
}

fn convert_to_rivet_v3_to_v4(message: v3::ToRivet) -> Result<v4::ToRivet> {
	convert_same_bytes(message)
}

fn convert_to_rivet_v4_to_v3(message: v4::ToRivet, target_version: u16) -> Result<v3::ToRivet> {
	match &message {
		...
		v4::ToRivet::ToRivetSqliteExecuteRequest(_) => {
			return Err(incompatible(
				ProtocolCompatibilityFeature::RemoteSqliteExecution,
				ProtocolCompatibilityDirection::ToRivet,
				4,
		...
		| v4::ToRivet::ToRivetStopping
		| v4::ToRivet::ToRivetPong(_)
		| v4::ToRivet::ToRivetKvRequest(_)
		| v4::ToRivet::ToRivetTunnelMessage(_)
		| v4::ToRivet::ToRivetSqliteGetPagesRequest(_)
		| v4::ToRivet::ToRivetSqliteCommitRequest(_) => {}
	}
...
mod tests {
	...
	use super::{ActorCommandKeyData, ProtocolCompatibilityFeature, ToEnvoy, ToEnvoyConn};
	use crate::{
		PROTOCOL_VERSION,
		generated::{v1, v2, v6},
	};
	...
	#[test]
	fn tunnel_pressure_round_trips_at_v6() -> Result<()> {
		let pressure = v6::ToEnvoy::ToEnvoyTunnelPressure(v6::ToEnvoyTunnelPressure {
			gateway_id: [1, 2, 3, 4],
			request_id: None,
			pressure: v6::Pressure {
				credit: 0,
				queue_depth: 32,
		...
		let encoded = ToEnvoy::wrap_latest(pressure).serialize_version(6)?;
		let decoded = ToEnvoy::deserialize_version(&encoded, 6)?.unwrap_latest()?;
		let v6::ToEnvoy::ToEnvoyTunnelPressure(decoded) = decoded else {
			panic!("expected tunnel pressure");
		};

		assert_eq!(decoded.gateway_id, [1, 2, 3, 4]);
		assert_eq!(decoded.pressure.queue_depth, 32);
		assert_eq!(decoded.pressure.oldest_age_ms, Some(500));

		Ok(())
	}

	#[test]
	fn tunnel_pressure_rejects_v5_targets() {
		let pressure = v6::ToEnvoy::ToEnvoyTunnelPressure(v6::ToEnvoyTunnelPressure {
			gateway_id: [1, 2, 3, 4],
			request_id: None,
			pressure: v6::Pressure {
		...
		let err = ToEnvoy::wrap_latest(pressure)
			.serialize_version(5)
			.expect_err("v6 pressure must not serialize to v5");
		let compat = err
			.downcast_ref::<super::ProtocolCompatibilityError>()
			.expect("expected protocol compatibility error");

		assert_eq!(compat.feature, ProtocolCompatibilityFeature::TunnelPressure);
		assert_eq!(compat.required_version, 6);
		assert_eq!(compat.target_version, 5);
	}

	#[test]
	fn tunnel_pressure_conn_rejects_v5_targets() {
		let pressure = v6::ToEnvoyConn::ToEnvoyTunnelPressure(v6::ToEnvoyTunnelPressure {
			gateway_id: [1, 2, 3, 4],
		...
		let err = ToEnvoyConn::wrap_latest(pressure)
			.serialize_version(5)
			.expect_err("v6 conn pressure must not serialize to v5");
		let compat = err
			.downcast_ref::<super::ProtocolCompatibilityError>()
			.expect("expected protocol compatibility error");
