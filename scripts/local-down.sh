#!/usr/bin/env bash
# scripts/local-down.sh — stop everything scripts/local-up.sh started.
...
sweep "runtime/parent-actor/src/parent.mts"   "parent"
sweep "scripts/spawn-engine.mts"              "engine spawner"
sweep ".cache/rivet-engine/rivet-engine"      "rivet-engine"
sweep ".cache/router/router"                  "router"
sleep 1
sweep "runtime/parent-actor/src/parent.mts"   "parent (kill)"
